...
Script: `episodes/episode-03/monster-mash-finale.md` (~2:30–3:00). Visible on the site **Suggestions** view.

## Visual arc

Lawn aftermath after snake battle → cold-open sing-us-out dialog → Rubella at silver mic → cursed Monster Mash party montage → parallel Lillith spy-heist in bedroom → hologram reveal → Rubella in white spy gear → Spy vs. Spy noir outro.
...
**Prompt variations**
```
Wide pan: Nixon mash center-left, Furbie swarm foreground, knife-kittens mid-ground, singer at mic right third, snake coils, Grok Imagine
```
```
Close-medium on porcelain dolls' cracked faces while Nixon's legs mash in soft bokeh behind, Halloween lawn, Grok Imagine
```

---

## 3 — The Heist / Verse 2 (1:00–1:25)
...
```
Cinematic medium still of woman unzipping an office chair cushion and revealing a large wide-brimmed black circular spy hat hidden inside, noir bedroom lighting, trenchcoat draped over arm, Grok Imagine style
```

---

## 4 — Party Escalates / Chorus 2 + Verse 3 (1:25–2:10)
...
```
```
Vintage couch wide: three lace women, younger dark-haired woman, crystal skull, white dog, skull tote, snake coils, Grok Imagine
```
```
Low-poly PS1 zombie clipping through lawn chair while Furbies pass in foreground, Grok Imagine
```

---

## 5 — Hologram Reveal / Bridge (2:10–2:45)
...
| 1:00–1:25 | 3 — Verse 2 + heist | Laboratory / vampires / electrodes |
| 1:25–2:10 | 4 — Chorus 2 + Verse 3 | Zombies / Wolfman / Crypt-Kicker Five |
| 2:10–2:45 | 5 — Verse 4 + bridge | Drac's Transylvania Twist / hologram |
| 2:45–3:30 | 6 — Final chorus + outro | Spy vs. Spy / Igor "Mash good!" |
