# Scratchpad — Quick Creative Captures

*Rapid-fire space for anything that comes up while working on weeks_of_fire. No pressure to structure perfectly — just capture the spark.*

## Scene Fragments & Partial Beats

- The pizza guy from Ep3 keeps showing up in other episodes as a running gag — always in different uniforms (UPS, cable guy, "spiritual advisor"), always completely calm. Never explains why he's everywhere.

- Two characters trying to have a serious breakup conversation while a marching band of glowing skeletons parades past the window. They keep having to pause for the tuba section.
...
- A single streetlight in the middle of a cornfield at night. Under it: a perfectly set dinner table for two, with two people eating like this is completely normal. In the distance, the faint glow of a city on fire.
...
- What if one of the musical cutaways is entirely from the POV of the black cat from Episode 3? No dialog, just Grok Imagine shots synced to a very cat-like, curious, slightly paranoid track.
...
---
*Tip: When an idea feels ready, copy it into `scene-suggestions.md`, `song-suggestions.md`, or `image-prompt-captures.md` and expand.*