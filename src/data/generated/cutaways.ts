    ...
    segments: [
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K night still of a warm-lamp wooden display cabinet packed with glass marbles on shallow shelves, two small speakers under the wood, neodymium cube magnets stacked two and three high shivering on the marble shelf, a short column of cylindrical disc magnets standing beside them mid-spin, one loose cube unstuck from a speaker basket mid-slide toward three empty wine glasses already on the next bay, a hanging pull-chain and loose washers on a nail, no people, no faces, short-film production still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Same warm-lamp wooden cabinet. Camera not inventing a second room. Slow track right. Glass marbles hop in place on the beat. Neodymium cubes stacked two and three high shiver and do not fall. Beside them a short column of cylindrical disc magnets spins in place, alternating discs turning opposite directions at once. A hanging pull-chain ticks against the cabinet side, washers rattle on a nail, and shelf dust jumps in the lamp beam. One cube unsticks from the speaker basket and slides toward three wine glasses already sitting on the next bay. Camera follows that one slide. Speakers pump. Nothing travels except that cube. No people, no faces, no creatures. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K still leaving a warm marble cabinet toward a dark interior doorway of the same night building, two silver sphere magnets on the wooden floor with a clean empty gap of several body-widths between them, both dead still, packed dirt visible beyond the threshold, old weathered fence already outside, wine glasses ringing out of frame left, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Leave the ringing wine glasses. Camera follows two silver sphere magnets rolling off the cabinet and across the floor. At the doorway they stop dead, a clean empty gap of several body-widths between them, and hold. On the next bass hit one crosses that gap in a single frame — a streak, nothing in between — and slams into the other, throwing a small puff of grit, and the pair buzzes together and settles. They roll on through the dark doorway and out onto packed dirt. An old weathered fence is already there. Red tower light far down the alley. One jump only. Do not cut during the jump. No people, no faces. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K low-angle night still on packed dirt, a large chrome sphere and a smaller black sphere sitting dead still with six body-widths of clean empty dirt between them, a streak of motion blur just starting to close the gap, dust hanging in moonlight, fence slats and frost ticking on wire, copper Rodin torus soft in the background down the alley, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Leave the Rodin behind but keep the same alley. Low camera on the dirt. A large chrome sphere and a smaller black sphere sit dead still, six body-widths of clean empty dirt between them. Hold on that gap. On the bass hit the smaller one crosses the whole gap in a single frame — a blurred streak, nothing in between — and slams into the chrome one. Grit puffs, one skid, then the pair buzzes hard together and settles over about half a second. Immediately after, the two counter-rotate around each other without ever touching again, turning about once per beat, gearing in the air. Grit hops in the ruts, a loose corrugated sheet oil-cans on the kick, a hubcap rings against the fence. One jump only, no cut during the jump, no contact after the gear starts. No people, no faces. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K night still on an unrealistically vivid emerald lawn, flowers too saturated for night, three industrial electromagnet coils in the grass under a tall precarious tower of mixed magnets — cubes, bars, spheres, a spinning column of cylindrical discs partway up, a small copper Rodin torus near the top — coils mid-glow, tower mid-rise, dew jumping off the blades, no rain, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Hold the frozen spheres two seconds. At the slam the camera is already on the unrealistically green lawn. Three industrial electromagnet coils sit in the grass under a tall precarious tower of mixed magnets — cubes, bars, spheres, a small Rodin torus near the top. Partway up the tower a column of cylindrical disc magnets spins, alternating discs turning opposite directions at once. On each bass hit the coils switch on and glow and the tower stands up straighter. In the gaps it slumps and starts to fall, then the next hit catches it. Flower heads nod on the kick, dew beads jump off the grass, standing water in a footprint rings. No rain. No people, no faces. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K closer night still of the same magnet tower on unrealistically green wet grass, three industrial coils pulsing in sequence around the base, silver spheres mid-orbit around the coil base, a pair of cylindrical rod magnets joined end to end tumbling end-over-end across the wet grass, the stack mid-slump being sucked back into shape, no rain, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Push closer to the same tower. It is the drum. The three coils fire in sequence around the base, one after another, and silver spheres lap the base about once per beat riding that sequence. A pair of cylindrical rod magnets joined end to end tumbles end-over-end across the wet grass, rotating around its own middle while the whole pair travels. The stack falls a foot and is sucked back into shape. Grass tips shiver, dew jumps, coil housings hum visibly. Do not let the tower collapse all the way. Do not let the rods be carried by anything. No rain. No people, no faces. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K night still at the dirt-and-grass seam, glossy black spiked ferrofluid raindrops hanging frozen in mid-air not yet falling, two sphere magnets waiting on the packed dirt, two cylindrical rod magnets standing upright in the dirt vibrating in place, fence behind, no magnet tower in frame, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Follow the loose sphere back to the dirt-and-grass seam. Above the seam, glossy black ferrofluid rain is hanging in the air, spiked, still frozen, not yet falling, each drop trembling on the tick without dropping. Spheres on the ground wait. Two cylindrical rod magnets stand upright in the dirt buzzing hard enough to blur and going nowhere. Fence behind. No tower in frame. No people, no faces, no creatures. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K night still pulling back up the same dirt alley, two equal ferrofluid-slick spheres mid-orbit around the empty point between them with nothing in the middle, the pair travelling up the rut as it rotates, the copper Rodin torus still clean and dry on the fence humming, warm doorway lamp ahead, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Pull back up the dirt alley the way we came. Two equal ferrofluid-slick spheres rotate around the empty point between them, about once per beat, with nothing at all in the middle — no third object, no support — and the whole rotating pair travels up the rut toward the doorway. Neither one is the center. Grit hops in the ruts, the bare bulb swings a few degrees. The copper Rodin torus is still on the fence, clean, humming, and does not travel. Camera goes through the same doorway toward the warm lamp. No people, no faces. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K still back on the original warm-lamp marble shelf, glass marbles on the wood, one wine glass, two sphere magnets still wearing black ferrofluid spinning around each other at the near end of a clean empty gap, a line of neodymium cube stacks waiting at the far end mid-snap into a locked chain, small speakers under the cabinet, nothing exploding off the wood, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "10-second continuous single take, no cut. Back on the original marble shelf, same wood as the opening. Marbles hop, the pull-chain ticks, washers rattle, ball bearings jump in a tin lid. The spinning ferrofluid-slick pair arrives at the near end of the shelf and stops, a clean empty gap of several body-widths between it and a waiting line of cube stacks. Hold on that gap. On the bass hit the pair crosses it in a single frame and slams into the line, and the snap runs away down the row, each stack locking to the next in sequence until the whole chain is one locked line. A rebound buzz, then still. Speakers pump. Camera holds. Nothing explodes off the wood. No people, no faces. Photoreal short-film, ~10 seconds.",
        promptVariations: [],
      ...
      },
      {
        ...
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "Cinematic 8K quiet still of one clear glass marble on the wooden shelf, two magnets a millimeter apart, one cylindrical disc magnet still standing on its end and spinning down with a slow wobble, a single frozen ferrofluid spike hanging in air and not falling, speakers dead, warm lamp, no people, short-film still, Grok Imagine style",
        geminiOmniPrompt: "3-second hold, camera not moving. One clear marble. Two magnets a millimeter apart. One cylindrical disc still standing on its flat end, spinning down, its axis wobbling wider and wider but never falling over. A single frozen ferrofluid spike hanging and not falling. Speakers dead. Hold. Cut before the disc stops. No people, no faces. Photoreal short-film, ~3 seconds.",
        promptVariations: [],
