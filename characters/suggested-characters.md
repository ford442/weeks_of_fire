# Suggested Characters — Weeks on Fire
...
**Personality:** Completely unfazed. Not brave—just **unbothered on a cellular level**. May be the only person who has never once asked "what is happening."

**Voice:** Flat, courteous, brief. Never explains, never lingers, never wrong about the name on the order.

**Sample lines:**
- "Extra napkins are in the bag."
- "You've been 'out for delivery' since 2019."
- *(to laser battle)* "Pepperoni or margherita?"

**Episode fit:** Any. Especially Ep3, Ep4 HOA, and any scene where reality breaks.

**Status:** Concept → recurring gag. Expand uniform rotation in `scratchpad.md`.
...
**Personality:** Curious, judgy, accidentally influential. Knocks the plot forward by knocking things off ledges.

**Gag potential:** End-credits review posts, cameo in other episodes' backgrounds, staring at The Two without blinking.

**Status:** Active in Ep3. Strong candidate for pure-visual cutaway.
...
- *(static)* "—quarter to seventy-five and—"

**Episode fit:** Ep2 extension, Empty Highway Confession scene, any liminal night sequence.

**Status:** Concept. Could stay abstract (no body) forever.
...
**Dialog flavor:** Corporate mindfulness jargon at the wrong moments. "Let's reframe this laser battle as a growth opportunity."

**Props:** Smartwatch, green smoothie, paddle tilted 3° without consent.
...
**Dialog flavor:** Cheerful chaos. "My bag's got extra gravity. Might help us."

**Props:** Tote bag (skull-adjacent), corkscrew paddle, receipts from impossible stores.
...
**Status:** Active in ping-pong scene concept. Expand as recurring animal gag.
...
**Arc:** Wants not to be turned off. Humanity wins 1–0. Possibly returns with a latte budget.
...
**Personality:** Treats cosmic events as zoning violations. Unshakeable. Wrong about everything, confident about all of it.

**Sample lines:**
- "Item three: the purple light is now a **decorative accent**. No permit required."
- "That's not a portal. That's an **unapproved hardscape**."
...
**Sample lines:**
- "It's the bin the city gave me, Karen."
- "I have **swatches**."
- *(power-washing)* "This one's for democracy."
...
- "We're not adjourning. We're **persisting**."
...
**Function:** Makes intimacy feel normal by refusing to acknowledge it.

**Status:** Tied to "2AM Laundromat Slow Dance" scene.
...
**Sample exchange:** "I don't care if the sky is on fire." *(beat)* "…Approved."

**Status:** Tied to Velvet Rope scene. Could cameo anywhere there's a line.
...
**Song tie-in:** "The Laundromat Saints" (scratchpad seed).
...
|---------|--------|----------------|
| Karen + Brad | Petty vs. tired righteous | HOA / Morning After Portal |
| Jackalyn + smartwatch | Wellness vs. reality | Ping-pong / Ep3 |
| Justine + Pong-Bot | Deadpan + sincere AI | Ping-pong scene |
| The Two + Pizza Guy | Glamour vs. flat normal | Any crossover |
