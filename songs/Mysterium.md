...
Minimax Music 2.6 tends to sing anything left inside brackets beyond the
plain section name, so keep tags bare ([Verse 1], [Chorus], [Bridge]) and
put all performance/arrangement direction in the STYLE block instead.
Lyrics are modern conversational Italian with the original Latin kept as
the chorus hook ("O magnum mysterium", "Alleluia", "et admirabile") and a
short chant quote in the bridge — pop first, hymn second.
