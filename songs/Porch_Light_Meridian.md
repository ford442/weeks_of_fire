...
Episode 3 crane reveal as music — suburban porch light in the foreground, meridian logic overhead. Complements Strange Light (daytime dual sky) with a night / after-chaos twin. Strongest Noah Cohn kinship (Meridian / Stella Porta). Starts ground-level deadpan, widens into quiet awe, ends unresolved (camera still rising). Visual: crane up from pizza box → roofs → moon with a wrong second glow; porch bulb as tiny sun against deep blue. Ready for Minimax.
