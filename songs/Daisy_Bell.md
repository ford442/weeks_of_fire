...
Public-domain standard staged as a Weeks on Fire musical cutaway: Rubella & Lillith ride a living flower bicycle from a modern wildflower field into period London. Visual language does a B&W film-scratch ↔ full-color HD flip (pipeline experiment). Hero props: black lace against chaotic color, flower bike constant across centuries. Production stills and keyframe board live on the site **Daisy Bell** page (`src/data/daisyBell.ts`). Concept: `ideas/daisy-bell-cutaway.md`.
